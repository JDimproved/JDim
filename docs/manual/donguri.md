...
2024年3月下旬頃から、どんぐりシステムというユーザー識別の仕組みが5ch.io（2026年3月より前は5ch.net）に導入されました。

どんぐりシステムには2種類のアカウントがあります。
- 5ch.ioの有料サービスUPLIFTの購読者がログインできる**ハンター**
...
2. 5ch.ioのどんぐりシステムが導入されている板やスレに書き込むと警備員○アカウントにログインします。
...
1. 5ch.ioのどんぐりシステムが導入されている板やスレに書き込むと、自動的に警備員○アカウントでログインします。
...
URL | 説明
--- | ---
<https://donguri.5ch.io>  | どんぐりシステムのトップページ (ログインページとどんぐりベース)
<https://donguri.5ch.io/faq>  | 公式FAQページ
<https://kes.5ch.io/donguri/> | 5ch.io どんぐり板 (どんぐりシステムの話題を扱う)
<http://dongurirank.starfree.jp/acorn.html> | 有志まとめ: どんぐりシステムが導入されている板一覧

[donguri-top]: https://donguri.5ch.io
