...
- zlib 1.2 以上
- gnutls 3.7.3 以上
- crypt(3) ( OS 依存のライブラリ。 Debian 系の場合は libcrypt-dev をインストール )

#### 推奨環境
- Linux kernel 5.15.0 以上
...
- openssl 3.0.2 以上 (`-Dtls=openssl`)
- migemo (`-Dmigemo=enabled`)
- googletest 1.11.0 以上 ([test/RADME.md][testreadme]を参照)
